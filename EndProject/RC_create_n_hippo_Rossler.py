...
rho = 8.436842105263159

sigma = 1.6631578947368424
...
# Define number of sets of CSV files
n = 50

# Loop to create and train reservoir computers, and save predicted and actual data to CSV files
for i in range(n):
    ...
    with open(f'predicted_data_hippo_rossler_V3_{i}.csv', 'w', newline='') as csvfile:
    ...
    with open(f'actual_data_hippo_rossler_V3_{i}.csv', 'w', newline='') as csvfile:
        writer = csv.writer(csvfile)
        writer.writerow(['x', 'y', 'z'])
