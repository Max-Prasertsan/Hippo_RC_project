...
for i in range(n):
    ...
    actual_data = np.genfromtxt(f'actual_data_hippo_V12_{i}.csv', delimiter=',', skip_header=1)
    predicted_data = np.genfromtxt(f'predicted_data_hippo_V12_{i}.csv', delimiter=',', skip_header=1)
